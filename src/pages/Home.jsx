        ...
        <div name="Home" className='h-full w-full p-4 overflow-hidden'>
            <div className='h-full rounded-lg p-5'>
                <div className='w-fit px-2 rounded-lg md:hidden flex gap-10' >
                    ...
                    <div><a href='https://www.linkedin.com/in/ankit-kushwaha-135817227' className='pi pi-linkedin text-3xl p-1 text-blue-700'> </a></div>
                    <div><a href='https://www.github.com/kush-ankit' className='pi pi-github text-3xl p-1'> </a></div>
                </div>
