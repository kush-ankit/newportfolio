            ...
            <div className='h-full rounded-lg p-5'>
                ...
                <div className='max-w-screen-lg mx-auto flex flex-col  items-center h-full md:flex-row'>
                    <div id='load' className='w-full my-10 delay-500'>
                        <h2 className='text-xl sm:text-2xl font-mono font-semibold'>Hola guys, I am<div className='text-4xl sm:text-7xl text-[#7fffd4] font-bold font-serif' style={{ textShadow: "3px 3px 8px #ccc" }}>Ankit <br /> Kushwaha</div> <div className='italic text-lg'>"Only you can understand your self"</div> </h2>
                    </div>
